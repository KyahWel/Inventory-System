...
<div class="container col-9">
    <h1>Employees</h1>
    <button class="add-employee" data-bs-toggle="modal" data-bs-target="#addEmployeeModal" id="addEmployee">Add Employee</button>
    <!-- TABLE -->
    <div class="container">
        <div class="row">
            <div class="col-md-12">
    ...
    <div class="modal fade" id="addEmployeeModal" tabindex="-1" aria-labelledby="viewAnnouncementHeader" aria-hidden="true">
    ...
    <div class="modal fade" id="viewEmployeeModal" tabindex="-1" aria-labelledby="viewAnnouncementHeader" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
